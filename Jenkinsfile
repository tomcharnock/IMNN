...
pip install pytest flake8 sphinx autoclasstoc ipython
pip install -e .'''
      }
    }
...
flake8 . --extend-exclude=dist,build,docs,examples,IMNN.egg-info,__pycache__,py_imnn,imnn/utils/jac.py,.ipynb_checkpoints --show-source --statistics'''
      }
    }
